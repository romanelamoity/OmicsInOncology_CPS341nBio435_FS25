...
plot_growth_curve <- function(data) {
  data %>%
    ggplot(aes(x = Time, y = OD600_blank_corrected, color = Strain, linetype = Growth_Medium, group = interaction(Strain, Growth_Medium, Replicate))) +
    geom_line(linewidth = 1, alpha = 0.7) +  # Plot lines
